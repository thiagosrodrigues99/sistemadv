...
export default function Sidebar({ isOpen, onItemClick }: { isOpen?: boolean, onItemClick?: () => void }) {
    ...
    <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
      ...
      <ul className="nav-menu" style={{ listStyle: 'none', flexGrow: 1 }}>
        <li className="nav-item" style={{ marginBottom: '0.5rem' }}>
          <Link to="/dashboard" className={`nav-link ${isActive('/dashboard') ? 'active' : ''}`} onClick={onItemClick}>
        ...
        <li className="nav-item" style={{ marginBottom: '0.5rem' }}>
          <Link to="/reunioes" className={`nav-link ${isActive('/reunioes') ? 'active' : ''}`} onClick={onItemClick}>
        ...
        <li className="nav-item" style={{ marginBottom: '0.5rem' }}>
          <Link to="/leads" className={`nav-link ${isActive('/leads') ? 'active' : ''}`} onClick={onItemClick}>
        ...
        <li className="nav-item" style={{ marginBottom: '0.5rem' }}>
          <Link to="/relatorios" className={`nav-link ${isActive('/relatorios') ? 'active' : ''}`} onClick={onItemClick}>
        ...
        <li className="nav-item" style={{ marginBottom: '0.5rem' }}>
          <Link to="/configuracoes" className={`nav-link ${isActive('/configuracoes') ? 'active' : ''}`} onClick={onItemClick}>
      ...
      <div className="sidebar-footer">
        ...
        >
          <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ width: '18px', height: '18px' }}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
          Sair
        </button>
      </div>
    </aside>
